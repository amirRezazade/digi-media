import { apiKey, genres, menu, manageMenu, moreFiltersToggle, showVpnModal, toggleMenu, switchTheme, getGenres, navControl, removeLoader } from "./funcs.js";
...
async function getMovie() {
  try {
    ...
    if (list.status_code == 34) {
      ...
      document.querySelector("#header-address").textContent = list.original_title;
      ...
      document.querySelector("#movie-name").textContent = list.original_title;
      document.querySelector("#movie-title").textContent = list.title || list.tagline;
      ...
      document.querySelector("#movie-runtime").textContent = list.runtime;
      document.querySelector("#movie-release_date").textContent = list.release_date;
