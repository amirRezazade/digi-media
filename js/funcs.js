...
function showVpnModal() {
  ...
  <div id="vpn-modal" class="w-screen h-screen fixed top-0 left-0 flex justify-center items-center z-999 bg-black/70  text-amber-400">
      <p clas="px-5">خطا در دریافت داده ها ! لطفا vpn  خود را روشن کنید.</p>
    </div>
 `;
}

export { apiKey, menu, genres, manageMenu, toggleMenu, switchTheme, moreFiltersToggle, getGenres, showVpnModal, navControl, removeLoader };
